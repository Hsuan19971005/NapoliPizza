    ...
    <div class="py-5">
        ...
        <section class="">
            <form action="" method="post" class="max-w-xl m-2 mx-auto text-xl text-black">
                ...
                <div class="mb-1 overflow-x-auto border-2 border-stone-500">
                    ...
                    <div class="flex px-3 py-2 bg-white">小計：<span class="ml-auto">${{ floor($item['product']->price * $item['quantity']) }}</span></div>
