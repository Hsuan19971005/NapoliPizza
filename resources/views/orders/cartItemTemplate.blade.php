<div id="cart-item-template" class="relative pt-7 px-0.5 pb-0.5 bg-pizza-yellow mb-2 hidden">
    <button class="absolute block w-5 h-5 top-1 right-1">
    ...
    <input type="number" name="products[]" hidden>
    <div class="flex bg-white">
        <div class="w-2/3 p-1 font-bold text-black bg-purple-400">
            <span >商品名稱</span>
            <span>x1</span>
            <span>$123</span>
        </div>
