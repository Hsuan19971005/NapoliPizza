<x-online-order-layout>
    ...
    <div class="py-12">
        ...
        <div class="relative flex justify-between max-w-6xl py-6 mx-auto">
            {{-- Menu --}}
            <ul id="mainMenu" class="absolute top-0 left-0 z-20 w-56 mb-auto text-black transition-transform duration-300 -translate-x-full bg-orange-100 border-2 border-orange-400 menu rounded-box md:translate-x-0 md:static">
                <!-- Delete button -->
                ...
                <li>
                    <details>
                        ...
                        <ul>
                        <li><a class="hover:bg-orange-300">套餐1</a></li>
                        <li><a class="hover:bg-orange-300">套餐2</a></li>
                        <li><a class="hover:bg-orange-300">套餐3</a></li>
                        </ul>
                    </details>
                    </li>
                <li>
                <li>
                    <details>
                        ...
                        <ul>
                        <li><a data-category="大披薩" class="category-link hover:bg-orange-300">大披薩(12")</a></li>
                        <li><a data-category="小披薩" class="category-link hover:bg-orange-300">小披薩(9")</a></li>
                        <li><a data-category="MINI披薩" class="category-link hover:bg-orange-300">Mini披薩(6")</a></li>
                        </ul>
                    </details>
                    </li>
                <li>
                    ...
                    <ul>
                        <li><a data-category="炸雞" class="category-link hover:bg-orange-300">炸雞 Fried Chicken</a></li>
                        <li><a data-category="烤雞" class="category-link hover:bg-orange-300">烤雞 Roast Chicken</a></li>
                    </ul>
                    </details>
                </li>
                <li>
                    <details>
                        ...
                        <ul>
                            <li><a data-category="烤點心" class="category-link hover:bg-orange-300">烘烤美味 Roast</a></li>
                            <li><a data-category="炸點心" class="category-link hover:bg-orange-300">酥炸好料 Fried</a></li>
                            <li><a data-category="拼盤" class="category-link hover:bg-orange-300">超值拼盤 Mix</a></li>
                        </ul>
                    </details>
                </li>
                <li>
                    <details>
                        ...
                        <ul>
                            <li><a data-category="飲料" class="category-link hover:bg-orange-300">碳酸&茶 Soft & Tea</a></li>
                        </ul>
                    </details>
                </li>
            </ul>
            ...
            {{-- Cart --}}
            <form id="cartMenu" action="{{ route('order.add-to-cart') }}" method="post" class="absolute top-0 right-0 z-20 p-3 mb-auto text-black transition-all duration-500 ease-in-out translate-x-full border-2 opacity-0 bg-amber-100 w-72 md:static md:opacity-100 md:translate-x-0 border-slate-500">
                @csrf
                ...
                <div class="flex mb-2">
                    <ul>
                        <li>服務方式：外帶</li>
                        <li>取餐日期：{{ $deliveryDate ?? '尚未選擇取餐日期' }}</li>
                        <li>服務門市：{{ $storeName ?? '尚未選擇服務門市' }}</li>
                    </ul>
