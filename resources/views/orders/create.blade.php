<x-online-order-layout>
    ...
    <div class="py-12 bg-slate-500">
        ...
        <div class="relative flex justify-between max-w-6xl py-6 mx-auto bg-purple-300 border-2">
            {{-- Menu --}}
            <ul id="mainMenu" class="absolute top-0 left-0 z-20 w-56 text-black transition-transform duration-300 -translate-x-full menu bg-rose-200 rounded-box md:translate-x-0 md:static">
                <!-- Delete button -->
